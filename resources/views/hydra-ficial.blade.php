      ...
      <section class="hydrafacial-hero text-center">
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="hydrafacial-hero-title animate__animated animate__fadeInDown">Advanced HydraFacial Treatment</h1>
                    <p class="hydrafacial-hero-subtitle animate__animated animate__fadeIn animate__delay-1s">Revitalize your skin with our medical-grade facial that cleanses, exfoliates, extracts, and hydrates</p>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <p class="lead">HydraFacial is a revolutionary, non-invasive skin treatment that combines cleansing, exfoliation, extraction, hydration, and antioxidant protection simultaneously.</p>
                    <p>Our advanced HydraFacial system delivers instant, noticeable results with no downtime. It's suitable for all skin types and addresses a wide range of skin concerns including fine lines and wrinkles, congested and enlarged pores, oily or acne-prone skin, hyperpigmentation, and uneven skin tone.</p>
                    <p>Unlike traditional facials, HydraFacial uses patented vortex technology to painlessly remove dead skin cells and impurities while simultaneously delivering nourishing serums tailored to your skin's unique needs.</p>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead mb-5">Experience the ultimate skin rejuvenation with our premium HydraFacial treatment</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-6 col-lg-4">
                    <div class="hydrafacial-glass-card p-4 h-100">
                        ...
                        <p class="text-center">See visible glow and refined skin texture immediately after your first session with our enhanced hydration technology.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="hydrafacial-glass-card p-4 h-100">
                        ...
                        <p class="text-center">Our patented delivery system transports active ingredients 3x deeper than standard treatments for lasting results.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="hydrafacial-glass-card p-4 h-100">
                        ...
                        <p class="text-center">Skin analysis technology creates a custom treatment protocol tailored to your unique skin profile and goals.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="hydrafacial-glass-card p-4 h-100">
                        ...
                        <p class="text-center">Advanced vortex technology provides exceptional results without irritation or recovery time.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="hydrafacial-glass-card p-4 h-100">
                        ...
                        <p class="text-center">Specialized serums repair and strengthen your skin's natural protective barrier for long-term health.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="hydrafacial-glass-card p-4 h-100">
                        ...
                        <p class="text-center">Advanced extraction removes environmental pollutants and impurities from deep within pores.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="hydrafacial-process-step">
                        ...
                        <h4>Cleanse + Peel</h4>
                        <p>Gentle exfoliation and relaxing resurfacing to remove dead skin cells and reveal a fresh layer of skin.</p>
                    </div>
                    <div class="hydrafacial-process-step">
                        <div class="hydrafacial-step-number">2</div>
                        <h4>Extract + Hydrate</h4>
                        <p>Painless vortex suction removes debris from pores while vortex-fused hydration nourishes the skin.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="hydrafacial-process-step">
                        ...
                        <h4>Boost + Protect</h4>
                        <p>Customized serums are applied to address your specific skin concerns like aging, dryness, or oiliness.</p>
                    </div>
                    <div class="hydrafacial-process-step">
                        <div class="hydrafacial-step-number">4</div>
                        <h4>Fuse + Protect</h4>
                        <p>LED light therapy enhances results by stimulating collagen production and killing acne-causing bacteria.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">After just 3 treatments over a span of 6 weeks, patients noticed a significant reduction in acne, visibly clearer skin, and a noticeable improvement in overall texture and tone. The skin appeared smoother, more balanced, and showed fewer signs of inflammation and breakouts.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">After 4 monthly treatments, patients observed a visible reduction in fine lines, improved skin elasticity, and a smoother, more youthful-looking complexion. The skin appeared firmer, more supple, and showed enhanced radiance and hydration, with long-lasting rejuvenating effects.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">After 5 treatments, patients experienced a noticeable evening out of skin tone, along with a significant reduction in dark spots and discoloration. The complexion appeared brighter, more balanced, and visibly refreshed.</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="timeline">
         ...
         <div class="timeline-item">
             <div class="timeline-content">
                 ...
                 <div class="testimonial-text">
                     <p>"The HydraFacial treatment left my skin glowing! I've never felt so refreshed after just one session."</p>
         ...
         <div class="timeline-item">
             <div class="timeline-content">
                 ...
                 <div class="testimonial-text">
                     <p>"My pores have never been cleaner. The extraction process was gentle yet incredibly effective."</p>
         ...
         <div class="timeline-item">
             <div class="timeline-content">
                 ...
                 <div class="testimonial-text">
                     <p>"After just 3 treatments, my acne scars have visibly faded and my complexion is more even."</p>
                     <h5>Olivia Chen</h5>
                     <span>HydraFacial Client</span>
                 </div>
             </div>
          ...
          <div class="laser-grid">
              ...
              <div class="laser-visual">
                  <div class="machine-wrapper">
                      <img src="assets/img/hydraMachine.jpg" alt="HydraFacial MD Elite Machine" class="main-machine">
                  ...
                  <div class="highlights-box">
                      <div class="highlight-item">
                          ...
                          <div>
                              ...
                              <p>Safe and effective for all skin tones and conditions, with customizable treatment options.</p>
                          </div>
                      </div>
                      ...
                      <div class="highlight-item">
                          ...
                          <div>
                              <h4>Instant Glow</h4>
                              <p>Patented vortex technology deeply cleanses and hydrates for immediate visible results.</p>
                          </div>
                      </div>
                      ...
                      <div class="highlight-item">
                          ...
                          <div>
                              ...
                              <p>Clinically proven to improve skin texture, tone, and hydration after just one treatment.</p>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="laser-details">
                  <div class="detail-card">
                      ...
                      <p>
                        The <strong>HydraFacial MD Elite</strong> uses patented vortex-fusion technology to deeply cleanse, exfoliate, extract impurities, and hydrate the skin. This multi-step treatment delivers instant, noticeable results with no discomfort or downtime.
                      </p>
                      <p>
                        The system's unique <strong>4-in-1 approach</strong> combines cleansing, exfoliation, extraction, and hydration with nourishing serums tailored to your specific skin concerns. The vortex suction removes dead skin cells and impurities while simultaneously delivering potent skin solutions.
                      </p>
                      <p>
                        With regular treatments, HydraFacial improves <strong>skin texture, tone, and elasticity</strong> while reducing fine lines, wrinkles, hyperpigmentation, and acne concerns.
                      </p>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="hydrafacial-price-card card">
                        ...
                        <div class="card-body text-center">
                            <div class="hydrafacial-price-amount">$149</div>
                            ...
                            <a href="#contact" class="btn btn-outline-primary w-100">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="hydrafacial-price-card card popular">
                        ...
                        <div class="card-body text-center">
                            <div class="hydrafacial-price-amount">$199</div>
                            <div class="hydrafacial-price-period">per session</div>
                            <ul class="list-unstyled my-4">
                            ...
                            <a href="#contact" class="btn hydrafacial-btn-primary w-100">Book Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="hydrafacial-price-card card">
                        ...
                        <div class="card-body text-center">
                            <div class="hydrafacial-price-amount">$249</div>
                            <div class="hydrafacial-price-period">per session</div>
                            <ul class="list-unstyled my-4">
                  ...
                  <div class="faq-container">
                      ...
                      <div class="faq-item faq-active">
                          ...
                          <div class="faq-content">
                              <p>
                                  HydraFacial is a non-invasive facial treatment that uses patented technology to cleanse, extract, and hydrate the skin. It combines cleansing, exfoliation, extraction, hydration, and antioxidant protection in one session to improve overall skin health and appearance.
                              </p>
                          </div>
                      ...
                      <div class="faq-item">
                          ...
                          <div class="faq-content">
                              <p>
                                  HydraFacial helps improve skin texture, tone, and overall appearance. It addresses concerns like fine lines, wrinkles, enlarged pores, oily skin, and hyperpigmentation. It delivers immediate, noticeable results without downtime.
                              </p>
                          </div>
                          <i class="faq-toggle bi bi-chevron-right"></i>
                      </div><!-- End Faq item-->
                      ...
                      <div class="faq-item">
                          ...
                          <div class="faq-content">
                              <p>
                                  Yes, HydraFacial is safe for all skin types, including sensitive skin. The treatment can be customized with different serums and intensities to suit individual skin concerns and goals.
                              </p>
                          </div>
                          <i class="faq-toggle bi bi-chevron-right"></i>
                      </div><!-- End Faq item-->
                      ...
                      <div class="faq-item">
                          ...
                          <div class="faq-content">
                              <p>
                                  For best results, it is recommended to get a HydraFacial once a month. Regular treatments help maintain healthy skin and improve long-term results.
                              </p>
                          </div>
                          <i class="faq-toggle bi bi-chevron-right"></i>
                      </div><!-- End Faq item-->
                      ...
                      <div class="faq-item">
                          ...
                          <div class="faq-content">
                              <p>
                                  No, there is no downtime. You can return to your normal activities immediately after the treatment. Some people may experience slight redness, but it typically fades quickly.
                              </p>
                          </div>
                          <i class="faq-toggle bi bi-chevron-right"></i>
                      </div><!-- End Faq item-->
                      ...
                      <div class="faq-item">
                          ...
                          <div class="faq-content">
                              <p>
                                  A typical HydraFacial treatment takes about 30 to 60 minutes, depending on the specific skin concerns being addressed and any add-on treatments selected.
                              </p>
                          </div>
                          <i class="faq-toggle bi bi-chevron-right"></i>
                      </div><!-- End Faq item-->
                      ...
                      <div class="faq-item">
                          ...
                          <div class="faq-content">
                              <p>
                                  Yes, HydraFacial can be safely combined with other skincare treatments such as LED therapy, chemical peels, or microneedling. Your skincare professional can recommend the best combination based on your skin's needs.
                              </p>
                          </div>
                          <i class="faq-toggle bi bi-chevron-right"></i>
                      </div><!-- End Faq item-->
        ...
        <div class="container position-relative py-5">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead text-white mb-5">Book your HydraFacial treatment today and experience the difference</p>
                    <div class="row justify-content-center">
                        <div class="col-md-8">
    ...
    <script>
        $(document).ready(function() {
            ...
            function animateHydraFacialOnScroll() {
                const elements = document.querySelectorAll('.hydrafacial-glass-card, .hydrafacial-process-step, .hydrafacial-testimonial-card, .hydrafacial-price-card');
