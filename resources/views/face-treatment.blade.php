...
<main style="margin: 0; font-family: 'Segoe UI', sans-serif; background: linear-gradient(135deg, #cfe8ff, #e0f2fe); color: #0f172a; overflow: hidden;">
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
      <div class="content">
        <h1 style="max-width: 650px; margin: auto; margin-bottom: 15px;">Face Treatment Services Available at Our Clinic</h1>
        <p style="max-width: 620px; margin: auto;">While we're still working on our online information, our expert Face Treatment services are currently available at Yorkshire Hair and Skin Solutions Clinic. Visit us or call to book your consultation today!</p>
