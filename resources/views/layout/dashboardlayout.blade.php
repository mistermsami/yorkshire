...
<head>
    ...
    {{-- <title>@yield('titleSection') | Yorkshire</title><!--begin::Primary Meta Tags--> --}}
    <!-- Optimised SEO Meta Tags -->
    <title>@yield('pageTitle', 'Dashboard') | Yorkshire Hair & Skin Solutions</title>
    ...
    <meta name="twitter:description"
        content="Hair transplant, PRP, HydraFacial & laser hair removal in Leeds. Trusted experts in skin & hair care.">
    <meta name="twitter:image" content="https://yorkshirehairandskinsolutions.co.uk/assets/img/gallery/gallery-7.jpg">
    ...
    <meta property="og:description"
        content="Leading skin and hair clinic in Meanwood, Leeds offering PRP, laser hair removal, HydraFacial & more.">
    <meta property="og:image" content="https://yorkshirehairandskinsolutions.co.uk/assets/img/gallery/gallery-7.jpg">
    <!-- Replace with your real image URL -->
    ...
    <div class="app-wrapper"> <!--begin::Header-->
            ...
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                            ...
                            {{-- <img src="dashboard/assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow" alt="User Image"> --}}
                            <span class="d-none d-md-inline">{{ Auth()->user()->name }}</span> </a>
                        <ul class="dropdown-menu dropdown-menu-md dropdown-menu-end" style="width: 100px;">
                            <!--begin::User Image-->
                            {{-- <li class="user-header text-bg-primary">
                                <img src="dashboard/assets/img/user2-160x160.jpg"
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link-->
                <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image-->
                    {{-- <img src="dashboard/assets/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text-->  --}}
                    <span class="brand-text fw-light">Yorkshire Solutions</span> <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open"> <a href="{{ route('admin-dashboard') }}"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{ route('hydra.index')}}" class="nav-link"> <i
                                            class="nav-icon bi bi-circle"></i>
                                        <p>Appointments</p>
                                    </a> </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{ route('prp.index')}}" class="nav-link"> <i
                                            class="nav-icon bi bi-circle"></i>
                                        <p>Appointments</p>
                                    </a> </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{ route(name: 'teeth.index')}}" class="nav-link"> <i
                                            class="nav-icon bi bi-circle"></i>
                                        <p>Appointments</p>
                                    </a> </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{ route(name: 'const.index')}}" class="nav-link"> <i
                                            class="nav-icon bi bi-circle"></i>
                                        <p>Appointments</p>
                                    </a> </li>
                            </ul>
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">@yield('pageName')</h3>
                        </div>
                        <div class="col-sm-6">
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            ...
            <!--begin::Copyright--> <strong>
                Copyright &copy; 2025&nbsp;
                <a href="https://yorkshirehairandskinsolutions.co.uk/"
                    class="text-decoration-none">yorkshirehairandskinsolutions.co.uk</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer> <!--end::Footer-->
