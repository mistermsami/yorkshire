<div>
    <div class="card mb-4">
        <div class="card-header">
            <h3 class="card-title">Teeth Appointments</h3>
        </div> <!-- /.card-header -->
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($appointments as $appointment)
                        <tr class="align-middle">
                            ...
                            <td>
                                <a target="_blank" href="{{ route('teeth.detail', $appointment->id)}}" class="btn btn-info btn-sm">View</a>
                                <a target="_blank" href="{{ route('teeth.edit', $appointment->id)}}" class="btn btn-warning btn-sm">Edit</a>
