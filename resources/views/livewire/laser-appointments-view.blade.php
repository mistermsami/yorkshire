                ...
                <tbody>
                    @foreach ($appointments as $appointment)
                        <tr class="align-middle">
                            ...
                            <td>
                                <a target="_blank" href="{{ route('laser.detail', $appointment->id)}}" class="btn btn-info btn-sm">View</a>
                                <a target="_blank" href="{{ route('laser.edit', $appointment->id)}}" class="btn btn-warning btn-sm">Edit</a>
