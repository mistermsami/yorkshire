                ...
                <tbody>
                    @foreach ($appointments as $appointment)
                        <tr class="align-middle">
                            ...
                            <td>
                                <a target="_blank" href="{{ route('prp.detail', $appointment->id)}}" class="btn btn-info btn-sm">View</a>
                                <a target="_blank" href="{{ route('prp.edit', $appointment->id)}}" class="btn btn-warning btn-sm">Edit</a>
