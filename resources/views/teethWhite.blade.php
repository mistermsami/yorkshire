            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 hero-content fade-in">
                        ...
                        <p class="hero-subtitle">Get a brighter, whiter smile in just one visit to our clinic. Safe,
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="tw-process-item">
                            ...
                            <p class="tw-step-description">Our dentist will examine your teeth and discuss your whitening
                                goals to determine the best approach for you.</p>
                        </div>
                        <div class="tw-process-item">
                            <div class="tw-step-indicator">2</div>
                            <h4 class="tw-step-title">Teeth Cleaning</h4>
                            <p class="tw-step-description">We'll professionally clean your teeth to remove plaque and
                                surface stains for optimal whitening results.</p>
                        </div>
                        <div class="tw-process-item">
                            <div class="tw-step-indicator">3</div>
                            <h4 class="tw-step-title">Gum Protection</h4>
                            <p class="tw-step-description">A protective barrier is applied to your gums to prevent
                                irritation from the whitening gel.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="tw-process-item">
                            ...
                            <p class="tw-step-description">The professional-grade whitening gel is carefully applied to your
                                teeth.</p>
                        </div>
                        <div class="tw-process-item">
                            <div class="tw-step-indicator">5</div>
                            <h4 class="tw-step-title">Activation</h4>
                            <p class="tw-step-description">A special light may be used to activate the gel and accelerate
                                the whitening process.</p>
                        </div>
                        <div class="tw-process-item">
                            <div class="tw-step-indicator">6</div>
                            <h4 class="tw-step-title">Final Results</h4>
                            <p class="tw-step-description">After 2-3 applications (about 45 minutes total), you'll see
                                dramatically whiter teeth!</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="testimonial-card">
                            <p class="testimonial-text">I was amazed by the results! My teeth are several shades whiter
                                after just one session. The staff was professional and made me feel comfortable throughout
                                the process.</p>
                    ...
                    <div class="col-md-4">
                        <div class="testimonial-card">
                            <p class="testimonial-text">As a coffee drinker, my teeth were badly stained. The whitening
                                treatment worked wonders! No sensitivity issues and the results have lasted for months.</p>
                    ...
                    <div class="col-md-4">
                        <div class="testimonial-card">
                            <p class="testimonial-text">I was nervous about teeth whitening, but the dentist explained
                                everything and made sure I was comfortable. The results were better than I expected!</p>
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-md-4">
                        <div class="pricing-card">
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 30 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;50</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 45 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;70</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 60 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;90</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Single whitening session
                                </li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Professional cleaning
                                </li>
                                {{-- <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Take-home maintenance kit</li> --}}
                                <li class="mb-2"><i class="fas fa-times text-secondary me-2"></i> No touch-up sessions
                                </li>
                            </ul>
                    ...
                    <div class="col-md-4">
                        <div class="pricing-card popular">
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 30 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;250</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 30 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;400</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 30 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;500</span></li>

                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Two whitening sessions
                                </li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Professional cleaning
                                </li>
                                {{-- <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Enhanced whitening gel</li> --}}
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 1 free touch-up session
                                </li>
                            </ul>
                        ...
                        <div class="pricing-card">
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 30 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;500</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 30 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;750</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 30 Minutes session <span
                                        style="color: #0077b6; font-weight: bold;"> &pound;900</span></li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Three whitening sessions
                                </li>
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Professional cleaning
                                </li>
                                {{-- <li class="mb-2"><i class="fas fa-check text-success me-2"></i> Premium whitening gel</li> --}}
                                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> 2 free touch-up sessions
                                </li>
                            </ul>
                            <a href="#contact" class="btn btn-whitening-outline-price w-100">Book Now</a>
                        </div>
        ...
        <section id="faq" class="faq section light-background">
            ...
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="faq-container">
                            ...
                            <div class="faq-item faq-active">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Yes, when performed by a dental professional, teeth whitening is completely safe.
                                        Our treatments are designed to minimize sensitivity and protect your enamel.
                                    </p>
                                </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Whitening results typically last between 6 months to 2 years, depending on your
                                        lifestyle and oral care habits. Avoiding coffee, tea, and smoking can help extend
                                        the brightness.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Some patients may experience mild sensitivity during or after treatment. This
                                        usually subsides within a day or two. We use desensitizing agents to keep you
                                        comfortable.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Our in-office whitening sessions typically take about 60 minutes. You can walk out
                                        with a noticeably brighter smile in just one visit.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Most people are eligible for whitening, but we always begin with a consultation to
                                        ensure it's safe for you, especially if you have dental restorations or sensitive
                                        teeth.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Professional whitening uses stronger, dentist-approved agents that deliver faster
                                        and more effective results without harming your teeth. OTC products are less potent
                                        and may take longer.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Whitening is most effective on natural teeth. It does not work on crowns, veneers,
                                        or fillings. We’ll evaluate your smile to tailor the best whitening plan for you.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        For 24–48 hours post-treatment, avoid dark-colored foods and drinks like coffee, red
                                        wine, and berries. Also avoid smoking to keep your results lasting longer.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                    ...
                    <div class="col mt-5">
                        @livewire(name: 'AppointmentForm.TeethAppointmentForm')
                    </div>
                </div>
            </div>
        </section>
