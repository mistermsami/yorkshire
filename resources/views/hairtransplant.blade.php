                    ...
                    <div class="col-lg-6 d-flex align-items-center">
                        <div class="" style="padding-right: 50px;">
                            ...
                            <div class="about-content">
                                <p>
                                    A hair transplant is a surgical procedure that moves hair follicles from a donor area (usually the back or sides of the scalp) to areas experiencing hair loss or thinning.
                                </p>
                                <div>
                    ...
                    <div class="row doc_details">
                        ...
                        <div class="col-md-7 Doctor1 grid-item">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card card_centered_content p-3" style="background-color: #1977cc; color: #f3f1ee;">
                                        {{-- <div class="icon">
                                            <i class="bi bi-award"></i>
                                        </div> --}}
                                        <div class="text">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="faq-container">
                            ...
                            <div class="faq-item">
                                <h3>Who is a good candidate for a hair transplant?</h3>
                                <div class="faq-content">
                                    <p>
                                        Ideal candidates are individuals experiencing pattern baldness, thinning hair, or hair loss due to injury, with sufficient donor hair available for transplantation.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                <h3>What are the different hair transplant techniques?</h3>
                                <div class="faq-content">
                                    <p>
                                        The two main techniques are Follicular Unit Transplantation (FUT) and Follicular Unit Extraction (FUE). FUT involves removing a strip of scalp, while FUE extracts individual follicles for transplantation.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        Yes, hair transplants are considered permanent since the transplanted hair follicles are resistant to hair loss and continue to grow naturally.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        The procedure can take anywhere from 4 to 8 hours, depending on the number of grafts being transplanted.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                <h3>Is a hair transplant painful?</h3>
                                <div class="faq-content">
                                    <p>
                                        The procedure is performed under local anesthesia, so you won’t feel pain during the transplant. Some discomfort or mild soreness may occur post-surgery.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                <h3>When will I see results from my hair transplant?</h3>
                                <div class="faq-content">
                                    <p>
                                        Initial hair shedding occurs within the first few weeks, and new hair growth starts around 3-4 months. Full results are typically visible within 9-12 months.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
                            ...
                            <div class="faq-item">
                                <h3>Are there any side effects of a hair transplant?</h3>
                                <div class="faq-content">
                                    <p>
                                        Common side effects include mild swelling, redness, itching, and temporary shock loss (temporary shedding of transplanted hair). These typically subside within a few weeks.
                                    </p>
                                </div>
                                <i class="faq-toggle bi bi-chevron-right"></i>
                            </div>
