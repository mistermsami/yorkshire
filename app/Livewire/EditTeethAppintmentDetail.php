...
class EditTeethAppintmentDetail extends Component
{
    ...
    {
        $appointment = Teeth_Appointment::findOrFail($this->appointmentId);
    ...
    public function updateAppointment()
    {
        ...
        Teeth_Appointment::where('id', $this->appointmentId)->update([
            'name' => $this->name,
            'email' => $this->email,
    ...
    {
        return view('livewire.edit-teeth-appintment-detail');
    }
}
