...
class TeethAppointmentsView extends Component
{
    use WithPagination;
    ...
    {
        try {
            Teeth_Appointment::findOrFail($this->deleteId)->delete();
    ...
    public function render()
    {
        ...
        return view('livewire.teeth-appointments-view', compact('appointments'));
    }
}
