...
class EditAppintmentDetail extends Component
{
    ...
    {
        $appointment = Hydra_Appointment::findOrFail($this->appointmentId);
    ...
    public function updateAppointment()
    {
        ...
        Hydra_Appointment::where('id', $this->appointmentId)->update([
            'name' => $this->name,
            'email' => $this->email,
    ...
    {
        return view('livewire.edit-appintment-detail');
    }
}
