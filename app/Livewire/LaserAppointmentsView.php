...
class LaserAppointmentsView extends Component
{
    use WithPagination;
    ...
    {
        try {
            Laser_Appointment::findOrFail($this->deleteId)->delete();
    ...
    public function render()
    {
        ...
        return view('livewire.laser-appointments-view', compact('appointments'));
    }
}
