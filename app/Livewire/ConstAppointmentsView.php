...
class ConstAppointmentsView extends Component
{
    use WithPagination;
    ...
    {
        try {
            ALLAppointment::findOrFail($this->deleteId)->delete();
    ...
    public function render()
    {
        ...
        return view('livewire.const-appointments-view', compact('appointments'));
    }
}
